...
#ifndef GKO_CORE_PRECONDITIONER_SPARSE_DISPLAY_HPP_
#define GKO_CORE_PRECONDITIONER_SPARSE_DISPLAY_HPP_


// source :
// https://people.sc.fsu.edu/~jburkardt/cpp_src/sparse_display/sparse_display.html
...
//
{
    ...
    command_unit << "set title '" << nz_num << " nonzeros for \"" << header
                 << "\"'\n";
    command_unit << "set timestamp\n";
    command_unit << "plot [y=" << m0 << ":" << m1 << "] [x=" << n0 << ":" << n1
...
void spy_ge(int m, int n, ValueType a[], string header)
...
#endif  // GKO_CORE_PRECONDITIONER_SPARSE_DISPLAY_HPP_
